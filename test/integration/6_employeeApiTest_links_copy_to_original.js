...
test('POST /employees', async () => {
    ...
    expect(savedEmployees[0]).to.deep.match({ uniqueKey: response.result._id.toString()}); // toString just for better error messages, in real life a better assertion should be used
